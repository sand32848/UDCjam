Shader "Fading/Surface/Dissolve/MetalBumped" {
	...
	SubShader {
		Tags { "RenderType"="Clipping" "IsEmissive" = "true"}
		LOD 200
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			{
				#if (FADE_PLANE || FADE_SPHERE)&&NOISETRIPLANAR
				WORLD_CLIP(IN.worldPos, WorldNormalVector (IN, o.Normal));
				#else
			...
			fixed4 fade = 
				#if NOISETRIPLANAR
				WORLD_FADE(IN.worldPos, WorldNormalVector (IN, o.Normal));
				#else
