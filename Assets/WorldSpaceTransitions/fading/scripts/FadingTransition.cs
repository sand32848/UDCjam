...
namespace WorldSpaceTransitions
{
    ...
    public class FadingTransition : MonoBehaviour
    {
        ...
        [System.Serializable]
        public class RingsOption
        {
            public bool useRings = false;
            [Range(0, 32)]
            public float ringsCount = 0;
            public bool animateRings = false;
            [Range(-1, 1)]
        ...
        public RingsOption ringsOption;
        //[SerializeField]
        //[HideInInspector]
        ...
        void OnValidate()
        {
           ...
           // if(instance) gradientOption.useGradient = gradientOption.useGradient && TransitionGradient.instance;
            ...
            if (ringsOption.useRings)
            {
                Shader.EnableKeyword("RINGS");
                Shader.SetGlobalFloat("_n_rings", ringsOption.ringsCount);
                Shader.SetGlobalFloat("_timeScale", ringsOption.timeScale);
                Shader.SetGlobalFloat("_animateRings", ringsOption.animateRings?1f:0f);
            }
            else
            {
                Shader.DisableKeyword("RINGS");
            }
