...
namespace WorldSpaceTransitions
{
    ...
    public static class NoiseGenerator
    {
        ...
        public static Texture3D Generate3D(ref Texture2D previewTex, float boxSize, int deepness, int delta, int resolution3d)
        {
            if (resolution3d > 256)
            {
                Debug.LogWarning("max resolution is 256");
            ...
            previewTex = new Texture2D(resolution3d, resolution3d, TextureFormat.RGB24, false);
            ...
            previewTex.SetPixels(previewCols);
            previewTex.Apply();
            t.SetPixels(cols);
            t.Apply();
            return t;
