...
namespace WorldSpaceTransitions
{
    ...
    public class TransitionGradient : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (FadingTransition.instance.gradientOption.useGradient)
            {
        ...
        void UpdateCurvesTexture()
        {
            ...
            if (texture == null)
            {
                ...
                texture = new Texture2D(256, 2, TextureFormat.RGB24, false, false);
        ...
        void OnValidate()
        {
        if (!FadingTransition.instance||processing) return;
            if (FadingTransition.instance.gradientOption.useGradient)
            UpdateCurvesTexture();
            Shader.SetGlobalTexture("_TransitionGradient", texture);
        }
