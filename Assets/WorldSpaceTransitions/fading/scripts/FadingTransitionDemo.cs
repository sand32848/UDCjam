    ...
    public class FadingTransitionDemo : MonoBehaviour
    {
        ...
        public void ModifyMaterials(int i)
        {
            ...
            else if (GraphicsSettings.renderPipelineAsset.name.Contains("URP"))
            {
                ...
                if (s == "dissolve") shader = Shader.Find("FadingURP/DissolveDouble");
                if (s == "dissolve double sided") shader = Shader.Find("FadingURP/DissolveDouble");
                if (s == "screenspace dissolve") shader = Shader.Find("FadingURP/ScreenspaceDissolveDouble");
                if (s == "screensp. diss. double") shader = Shader.Find("FadingURP/ScreenspaceDissolveDouble");
                if (s == "dissolve glow 1/s") shader = Shader.Find("FadingURP/DissolveGlowDouble");
                if (s == "dissolve glow 2/s") shader = Shader.Find("FadingURP/DissolveGlowDouble");
                if (s == "screensp. diss. glow 1/s") shader = Shader.Find("FadingURP/ScreenspaceDissolveGlowDouble");
                if (s == "screensp. diss. glow 2/s") shader = Shader.Find("FadingURP/ScreenspaceDissolveGlowDouble");
                ...
                {
                    m.shader = shader;
                    //if (m.HasProperty("_doubleSided")) Debug.Log("ds");
                    if (m.HasProperty("_doubleSided")) m.SetFloat("_doubleSided", (s.Contains("double") || s.Contains("2/s")) ? 1 : 0);
                }
            }
